...
namespace pdn::dev_util
{
	...
	inline auto err_msg_gen_en(utf_32_decode_error_code errc, source_position, raw_error_message_variant raw) -> error_msg_string
	{
		using namespace err_msg_gen_util;
		using namespace error_message_literals;
		using enum utf_32_decode_error_code;
		const auto& msg = ::std::get<raw_error_message_type::utf_32_decode_error>(raw);
		switch (errc)
		{
