...
namespace pdn
{
	...
	template <typename char_t>
	[[nodiscard]] inline auto as_char(const entity<char_t>& e) -> types::character<char_t>
	{
		return ::std::visit([](const auto& v) { return dev_util::as_accessor<char_t>::as_char(v); }, e);
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_string(const entity<char_t>& e) -> const types::string<char_t>&
	{
		return ::std::visit([](const auto& v) -> decltype(auto) { return dev_util::as_accessor<char_t>::as_string(v); }, e);
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_list(const entity<char_t>& e) -> const types::list<char_t>&
	{
		return ::std::visit([](const auto& v) -> decltype(auto) { return dev_util::as_accessor<char_t>::as_list(v); }, e);
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_object(const entity<char_t>& e) -> const types::object<char_t>&
	{
		return ::std::visit([](const auto& v) -> decltype(auto) { return dev_util::as_accessor<char_t>::as_object(v); }, e);
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_int(const_refer<char_t> e) -> types::i64
	{
		return e ? as_int(*e) : types::i64{};
	}

	template <typename char_t, types::concepts::pdn_sint in>
	[[nodiscard]] inline auto as_int(const const_refer<char_t>& e, in tag) -> in
	{
		return e ? as_int(*e, tag) : in{};
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_uint(const_refer<char_t> e) -> types::u64
	{
		return e ? as_uint(*e) : types::u64{};
	}

	template <typename char_t, types::concepts::pdn_uint un>
	[[nodiscard]] inline auto as_uint(const const_refer<char_t>& e, un tag) -> un
	{
		return e ? as_uint(*e, tag) : un{};
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_fp(const_refer<char_t> e) -> types::f64
	{
		return e ? as_fp(*e) : types::f64{};
	}

	template <typename char_t, types::concepts::pdn_fp fn>
	[[nodiscard]] inline auto as_fp(const const_refer<char_t>& e, fn tag) -> fn
	{
		return e ? as_fp(*e, tag) : fn{};
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_bool(const_refer<char_t> e) -> types::boolean
	{
	...
	template <typename char_t>
	[[nodiscard]] inline auto as_string(const_refer<char_t> e) -> const types::string<char_t>&
	{
		return e ? as_string(*e) : dev_util::as_accessor<char_t>::null_string_val();
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_list(const_refer<char_t> e) -> const types::list<char_t>&
	{
		return e ? as_list(*e) : dev_util::as_accessor<char_t>::null_list_val();
	}

	template <typename char_t>
	[[nodiscard]] inline auto as_object(const_refer<char_t> e) -> const types::object<char_t>&
	{
