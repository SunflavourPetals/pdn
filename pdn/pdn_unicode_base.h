...
{
	[[nodiscard]] unicode::u8string operator ""_s(const unicode::u8char_t* ptr, ::std::size_t length)
	{
		return unicode::u8string{ ptr, length };
	}
	[[nodiscard]] unicode::u16string operator ""_s(const unicode::u16char_t* ptr, ::std::size_t length)
	{
		return unicode::u16string{ ptr, length };
	}
	[[nodiscard]] unicode::u32string operator ""_s(const unicode::u32char_t * ptr, ::std::size_t length)
	{
		return unicode::u32string{ ptr, length };
	}
	[[nodiscard]] unicode::u8string_view operator ""_sv(const unicode::u8char_t* ptr, ::std::size_t length)
	{
		return unicode::u8string_view{ ptr, length };
	}
	[[nodiscard]] unicode::u16string_view operator ""_sv(const unicode::u16char_t * ptr, ::std::size_t length)
	{
		return unicode::u16string_view{ ptr, length };
	}
	[[nodiscard]] unicode::u32string_view operator ""_sv(const unicode::u32char_t * ptr, ::std::size_t length)
	{
