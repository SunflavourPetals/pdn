...
{
	using utf_32_encode_error_code = unicode::utf_32::encode_error_code;

	inline auto err_msg_gen_en(utf_32_encode_error_code errc, source_position, raw_err_v_cref raw) -> error_msg_string
	{
		return {};
	}
	inline constexpr error_msg_string err_msg_gen_en_remove(unicode::utf_32::encode_error_code errc, error_msg_string src)
	{
